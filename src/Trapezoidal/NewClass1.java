...
public class NewClass1 {
    ...
    public static ArrayList<Pix> separa(int k0, int k1, int ancho, int alto){
    ...
    public static Image trapezoidal(int k0, int k1, int ancho, int alto){
        return imagenResultante(separa(k0, k1, ancho, alto), ancho, alto);
    }
...
//        Image imagen = ImageManager.openImage();
        ...
        JFrameImagen frame1 = new JFrameImagen(trapezoidal(5, 400, ancho, alto));
